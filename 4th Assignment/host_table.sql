CREATE TABLE Host
  AS (SELECT DISTINCT host_id as id, host_url as url,host_name as name,host_since as since,host_location as location,
	  ...
	  host_is_superhost as is_superhost,host_thumbnail_url as thumbnail_url,host_picture_url as picture_url,
  ...
  ALTER TABLE Listing 
  ADD FOREIGN  KEY (host_id) REFERENCES host(id); --sto listing mpainei to foreign
